...
echo "This script installs a new BookStack instance on a fresh Debian 11 server."
...
function run_package_installs() {
  apt update
  apt install -y git unzip apache2 php curl php-curl php-mbstring php-ldap \
  php-xml php-zip php-gd php-mysql default-mysql-server libapache2-mod-php
}
